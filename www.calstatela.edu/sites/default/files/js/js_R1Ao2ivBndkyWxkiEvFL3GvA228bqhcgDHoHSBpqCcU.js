...
$(window).load(function() {
  // Load calendar script for WYSIWYG name attribute
  if ( $('.acalog').length > 0 ) {
    console.log('Acalog script from theme JS ran.');
    $( ".acalog" ).each(function( index ) {
      //do a for loop in the future if client ask for more attributes
      var attr = $(this).attr("data-acalog-page-");
      if (typeof attr !== typeof undefined && attr !== false) {
        $(this).removeAttr("data-acalog-page-");
        var pageName = $(this).attr("name");
        $(this).attr("data-acalog-page-name",pageName);
      }
      var attr2 = $(this).attr("data-acalog-program-");
      if (typeof attr2 !== typeof undefined && attr2 !== false) {
        $(this).removeAttr( "data-acalog-program-" );
        var programName = $(this).attr("name");
        $(this).attr("data-acalog-program-name",programName);
      }
      var attr3 = $(this).attr("data-acalog-entity-");
      if (typeof attr3 !== typeof undefined && attr3 !== false) {
        $(this).removeAttr( "data-acalog-entity-" );
        var entityName = $(this).attr("name");
        $(this).attr("data-acalog-entity-name",entityName);
      }
  ...
  setTimeout(function(){
    ...
    $('.block-og-menu ul li a.menu__link.active').each(function() {
      $(this).parents('li').addClass('is-active-trail');
    })
    //add classes to first og menu item if just 1 1-st level parent item exists
    if($('.region-sidebar-first .block-og-menu').length > 0 && $('.region-sidebar-first .block-og-menu > ul > li').next('li').length == 0) {
        $('.region-sidebar-first .block-og-menu > ul > li').addClass('opened').addClass('first-single');
    }
  ...
  Drupal.behaviors.keyboardaccessibility = {
    attach: function (context, settings) {
      ...
      function sectionMenuTabIndex() {
        jQuery('.region-menu-horizontal .menu').each(function () {
          if (jQuery(this).hasClass('opened') || jQuery(window).width() > 991) {
            jQuery(this).find('a').attr('tabindex', '0');
          } else {
            jQuery(this).find('a').attr('tabindex', '-1');
          }
        });
        jQuery('.block-og-menu .menu__item').each(function () {
          if (jQuery(this).hasClass('opened') || jQuery(window).width() > 991) {
            jQuery(this).find('.menu a').attr('tabindex', '0');
          } else {
            jQuery(this).find('.menu a').attr('tabindex', '-1');
          }
        });
      ...
      function addChildMenuToggle() {
        jQuery('.region-menu-horizontal .menu.opened > li > a, .region-sidebar .block-og-menu .menu.opened > li').each(function () {
